...
**이관 위치**: `spec/spec/components/embedder.md`
...
**이관 위치**: (embedder 프로젝트 문서) · 클라이언트 측은 `spec/spec/components/embedder.md`
...
- `spec/spec/components/embedder.md` — 클라이언트 사용법 · proto 요약 · Info 캐시 정책
