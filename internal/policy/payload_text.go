...
// Verified via byte-for-byte golden fixture test.
//
...
//  2. Blank line collapse + strip: while "\n\n\n" in text:
//     text = text.replace("\n\n\n", "\n\n"); then .strip()
//  3. _format_alternatives "chosen" marker bug: chosen=="" makes all
//     alternatives marked "(chosen)" — current reference behavior, keep bit-identical
